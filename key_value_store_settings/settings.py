"""
Django settings for python-django-key_value_store project.
...
ROOT_URLCONF = 'key_value_store_settings.urls'
...
WSGI_APPLICATION = 'key_value_store_settings.wsgi.application'
